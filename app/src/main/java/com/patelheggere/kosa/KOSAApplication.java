...
public class KOSAApplication extends Application {
    private static KOSAApplication mInstance;
    ...
    public static synchronized KOSAApplication getInstance() {
        return mInstance;
    }
}